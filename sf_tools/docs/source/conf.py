# -*- coding: utf-8 -*-
#
# sf_tools documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'sf_tools.tex', u'sf_tools Documentation',
...
man_pages = [
    (master_doc, 'sf_tools', u'sf_tools Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'sf_tools', u'sf_tools Documentation',
     author, 'sf_tools', 'One line description of project.',
     'Miscellaneous'),
]
